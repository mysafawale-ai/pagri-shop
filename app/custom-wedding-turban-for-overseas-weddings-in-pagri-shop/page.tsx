...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/custom-wedding-turban-for-overseas-weddings-in-pagri-shop",
    type: "website",
  },
}
...
export default function CustomWeddingTurbanForOverseasWeddingsInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Complete barati packages with matching coordination", "Emergency last-minute service available in India", "Perfect fit with maximum comfort guaranteed all day", "Customized designs matching your wedding theme and outfit", "On-site professional service at your India venue"],
