...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/barati-safa-on-rent-in-pagri-shop",
    type: "website",
  },
}
...
export default function BaratiSafaOnRentInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Expert safa specialists with 40+ years experience in India", "On-site professional service at your India venue", "Competitive pricing for individual and bulk orders", "Complete barati packages with matching coordination", "Authentic traditional tying techniques perfected over generations"],
