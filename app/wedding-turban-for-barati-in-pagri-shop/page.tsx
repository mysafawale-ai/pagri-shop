...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/wedding-turban-for-barati-in-pagri-shop",
    type: "website",
  },
}
...
export default function WeddingTurbanForBaratiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Authentic traditional tying techniques perfected over generations", "On-site professional service at your India venue", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in India", "Complete barati packages with matching coordination"],
