...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/premium-pagdi-with-kalgi-in-pagri-shop",
    type: "website",
  },
}
...
export default function PremiumPagdiWithKalgiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your India venue", "Customized designs matching your wedding theme and outfit", "Perfect fit with maximum comfort guaranteed all day", "Emergency last-minute service available in India"],
