...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/rajput-pagdi-in-pagri-shop",
    type: "website",
  },
}
...
export default function RajputPagdiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Expert pagdi specialists with 40+ years experience in India", "Perfect fit with maximum comfort guaranteed all day", "Free consultation and design preview via WhatsApp", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in India"],
