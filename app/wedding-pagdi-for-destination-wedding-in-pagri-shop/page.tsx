...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/wedding-pagdi-for-destination-wedding-in-pagri-shop",
    type: "website",
  },
}
...
export default function WeddingPagdiForDestinationWeddingInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert pagdi specialists with 40+ years experience in India", "Authentic traditional tying techniques perfected over generations", "Complete barati packages with matching coordination", "On-site professional service at your India venue", "Perfect fit with maximum comfort guaranteed all day", "Customized designs matching your wedding theme and outfit"],
