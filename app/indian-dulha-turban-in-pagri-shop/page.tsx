...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/indian-dulha-turban-in-pagri-shop",
    type: "website",
  },
}
...
export default function IndianDulhaTurbanInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Expert turban specialists with 40+ years experience in India", "Free consultation and design preview via WhatsApp", "Complete barati packages with matching coordination", "On-site professional service at your India venue", "Perfect fit with maximum comfort guaranteed all day"],
