...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/marathi-pheta-in-pagri-shop",
    type: "website",
  },
}
...
export default function MarathiPhetaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Customized designs matching your wedding theme and outfit", "Authentic traditional tying techniques perfected over generations", "Perfect fit with maximum comfort guaranteed all day", "Competitive pricing for individual and bulk orders", "Complete barati packages with matching coordination"],
