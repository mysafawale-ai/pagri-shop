...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/safa-for-men-in-pagri-shop",
    type: "website",
  },
}
...
export default function SafaForMenInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in India", "Free consultation and design preview via WhatsApp", "Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics"],
