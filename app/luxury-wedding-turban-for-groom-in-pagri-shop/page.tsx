...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/luxury-wedding-turban-for-groom-in-pagri-shop",
    type: "website",
  },
}
...
export default function LuxuryWeddingTurbanForGroomInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "On-site professional service at your India venue", "Emergency last-minute service available in India", "Customized designs matching your wedding theme and outfit", "Authentic traditional tying techniques perfected over generations", "Competitive pricing for individual and bulk orders"],
