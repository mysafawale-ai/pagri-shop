...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/wedding-safa-for-rent-in-pagri-shop",
    type: "website",
  },
}
...
export default function WeddingSafaForRentInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Customized designs matching your wedding theme and outfit", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your India venue", "Emergency last-minute service available in India", "Free consultation and design preview via WhatsApp"],
