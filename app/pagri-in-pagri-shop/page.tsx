...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/pagri-in-pagri-shop",
    type: "website",
  },
}
...
export default function PagriInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in India", "Authentic traditional tying techniques perfected over generations", "Expert pagri specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit"],
