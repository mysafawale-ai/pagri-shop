...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/luxury-wedding-turban-in-pagri-shop",
    type: "website",
  },
}
...
export default function LuxuryWeddingTurbanInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Expert turban specialists with 40+ years experience in India", "Emergency last-minute service available in India", "On-site professional service at your India venue", "Perfect fit with maximum comfort guaranteed all day", "Premium materials - silk, brocade, velvet, and designer fabrics"],
