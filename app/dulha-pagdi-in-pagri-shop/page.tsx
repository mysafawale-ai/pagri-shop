...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/dulha-pagdi-in-pagri-shop",
    type: "website",
  },
}
...
export default function DulhaPagdiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in India", "Complete barati packages with matching coordination", "On-site professional service at your India venue", "Expert pagdi specialists with 40+ years experience in India", "Free consultation and design preview via WhatsApp"],
