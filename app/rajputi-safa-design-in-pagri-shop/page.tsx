...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/rajputi-safa-design-in-pagri-shop",
    type: "website",
  },
}
...
export default function RajputiSafaDesignInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in India", "Expert safa specialists with 40+ years experience in India", "Free consultation and design preview via WhatsApp", "On-site professional service at your India venue", "Authentic traditional tying techniques perfected over generations", "Perfect fit with maximum comfort guaranteed all day"],
