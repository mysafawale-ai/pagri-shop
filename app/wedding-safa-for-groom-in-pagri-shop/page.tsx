...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/wedding-safa-for-groom-in-pagri-shop",
    type: "website",
  },
}
...
export default function WeddingSafaForGroomInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "Complete barati packages with matching coordination", "Customized designs matching your wedding theme and outfit", "On-site professional service at your India venue", "Emergency last-minute service available in India", "Competitive pricing for individual and bulk orders"],
