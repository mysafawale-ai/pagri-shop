...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/buy-wedding-safa-in-pagri-shop",
    type: "website",
  },
}
...
export default function BuyWeddingSafaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Complete barati packages with matching coordination", "Authentic traditional tying techniques perfected over generations", "Expert safa specialists with 40+ years experience in India", "Perfect fit with maximum comfort guaranteed all day", "Premium materials - silk, brocade, velvet, and designer fabrics"],
