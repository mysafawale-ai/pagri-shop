...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/pagdi-for-marriage-in-pagri-shop",
    type: "website",
  },
}
...
export default function PagdiForMarriageInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Emergency last-minute service available in India", "Expert pagdi specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your India venue"],
