...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/wedding-feta-in-pagri-shop",
    type: "website",
  },
}
...
export default function WeddingFetaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Perfect fit with maximum comfort guaranteed all day", "Expert feta specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit", "On-site professional service at your India venue", "Premium materials - silk, brocade, velvet, and designer fabrics"],
