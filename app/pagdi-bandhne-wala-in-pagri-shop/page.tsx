...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/pagdi-bandhne-wala-in-pagri-shop",
    type: "website",
  },
}
...
export default function PagdiBandhneWalaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Premium materials - silk, brocade, velvet, and designer fabrics", "Emergency last-minute service available in India", "Free consultation and design preview via WhatsApp", "Expert pagdi specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit"],
