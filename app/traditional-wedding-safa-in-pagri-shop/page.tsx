...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/traditional-wedding-safa-in-pagri-shop",
    type: "website",
  },
}
...
export default function TraditionalWeddingSafaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Complete barati packages with matching coordination", "Expert safa specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit", "Authentic traditional tying techniques perfected over generations", "Perfect fit with maximum comfort guaranteed all day"],
