...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/safa-shop-in-pagri-shop",
    type: "website",
  },
}
...
export default function SafaShopInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Free consultation and design preview via WhatsApp", "Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your India venue", "Expert safa specialists with 40+ years experience in India", "Authentic traditional tying techniques perfected over generations"],
