...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/wedding-safa-on-rent-in-pagri-shop",
    type: "website",
  },
}
...
export default function WeddingSafaOnRentInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Perfect fit with maximum comfort guaranteed all day", "Emergency last-minute service available in India", "On-site professional service at your India venue", "Expert safa specialists with 40+ years experience in India", "Authentic traditional tying techniques perfected over generations"],
