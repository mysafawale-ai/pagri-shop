...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/safa-pagdi-in-pagri-shop",
    type: "website",
  },
}
...
export default function SafaPagdiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert pagdi specialists with 40+ years experience in India", "Competitive pricing for individual and bulk orders", "Complete barati packages with matching coordination", "Authentic traditional tying techniques perfected over generations", "Emergency last-minute service available in India", "Customized designs matching your wedding theme and outfit"],
