...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/groom-turban-in-pagri-shop",
    type: "website",
  },
}
...
export default function GroomTurbanInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Emergency last-minute service available in India", "Authentic traditional tying techniques perfected over generations", "Perfect fit with maximum comfort guaranteed all day", "Expert turban specialists with 40+ years experience in India", "Competitive pricing for individual and bulk orders"],
