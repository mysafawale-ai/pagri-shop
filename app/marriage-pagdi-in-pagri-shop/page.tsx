...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/marriage-pagdi-in-pagri-shop",
    type: "website",
  },
}
...
export default function MarriagePagdiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Authentic traditional tying techniques perfected over generations", "Perfect fit with maximum comfort guaranteed all day", "Expert pagdi specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit", "On-site professional service at your India venue"],
