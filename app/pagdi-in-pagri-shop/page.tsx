...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/pagdi-in-pagri-shop",
    type: "website",
  },
}
...
export default function PagdiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Emergency last-minute service available in India", "Complete barati packages with matching coordination", "Expert pagdi specialists with 40+ years experience in India", "Free consultation and design preview via WhatsApp", "Authentic traditional tying techniques perfected over generations"],
