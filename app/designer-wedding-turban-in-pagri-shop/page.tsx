...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/designer-wedding-turban-in-pagri-shop",
    type: "website",
  },
}
...
export default function DesignerWeddingTurbanInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Perfect fit with maximum comfort guaranteed all day", "Competitive pricing for individual and bulk orders", "Expert turban specialists with 40+ years experience in India", "On-site professional service at your India venue", "Premium materials - silk, brocade, velvet, and designer fabrics"],
