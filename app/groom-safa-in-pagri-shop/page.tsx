...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/groom-safa-in-pagri-shop",
    type: "website",
  },
}
...
export default function GroomSafaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Free consultation and design preview via WhatsApp", "Authentic traditional tying techniques perfected over generations", "On-site professional service at your India venue", "Expert safa specialists with 40+ years experience in India", "Emergency last-minute service available in India", "Complete barati packages with matching coordination"],
