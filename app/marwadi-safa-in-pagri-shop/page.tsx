...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/marwadi-safa-in-pagri-shop",
    type: "website",
  },
}
...
export default function MarwadiSafaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "Complete barati packages with matching coordination", "Expert safa specialists with 40+ years experience in India", "Emergency last-minute service available in India", "Premium materials - silk, brocade, velvet, and designer fabrics", "Perfect fit with maximum comfort guaranteed all day"],
