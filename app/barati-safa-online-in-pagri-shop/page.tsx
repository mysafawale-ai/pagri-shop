...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/barati-safa-online-in-pagri-shop",
    type: "website",
  },
}
...
export default function BaratiSafaOnlineInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your India venue", "Customized designs matching your wedding theme and outfit", "Perfect fit with maximum comfort guaranteed all day", "Free consultation and design preview via WhatsApp", "Authentic traditional tying techniques perfected over generations"],
