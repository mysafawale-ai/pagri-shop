...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/safa-garments-in-pagri-shop",
    type: "website",
  },
}
...
export default function SafaGarmentsInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert safa specialists with 40+ years experience in India", "Perfect fit with maximum comfort guaranteed all day", "Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp", "Authentic traditional tying techniques perfected over generations", "On-site professional service at your India venue"],
