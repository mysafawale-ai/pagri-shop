...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/dulhe-ki-pagdi-in-pagri-shop",
    type: "website",
  },
}
...
export default function DulheKiPagdiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Emergency last-minute service available in India", "Free consultation and design preview via WhatsApp", "Authentic traditional tying techniques perfected over generations", "Expert pagdi specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit"],
