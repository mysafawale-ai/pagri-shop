...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/ready-made-turban-in-pagri-shop",
    type: "website",
  },
}
...
export default function ReadyMadeTurbanInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp", "Perfect fit with maximum comfort guaranteed all day", "Emergency last-minute service available in India", "Authentic traditional tying techniques perfected over generations", "Expert turban specialists with 40+ years experience in India"],
