...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/rajputi-safa-in-pagri-shop",
    type: "website",
  },
}
...
export default function RajputiSafaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Customized designs matching your wedding theme and outfit", "Expert safa specialists with 40+ years experience in India", "On-site professional service at your India venue", "Competitive pricing for individual and bulk orders", "Complete barati packages with matching coordination"],
