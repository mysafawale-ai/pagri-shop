...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/sehra-dulha-in-pagri-shop",
    type: "website",
  },
}
...
export default function SehraDulhaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Competitive pricing for individual and bulk orders", "Complete barati packages with matching coordination", "Free consultation and design preview via WhatsApp", "Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your India venue", "Expert sehra specialists with 40+ years experience in India"],
