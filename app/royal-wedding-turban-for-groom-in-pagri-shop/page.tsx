...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/royal-wedding-turban-for-groom-in-pagri-shop",
    type: "website",
  },
}
...
export default function RoyalWeddingTurbanForGroomInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "On-site professional service at your India venue", "Complete barati packages with matching coordination", "Emergency last-minute service available in India", "Expert turban specialists with 40+ years experience in India", "Perfect fit with maximum comfort guaranteed all day"],
