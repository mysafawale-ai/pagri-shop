...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/safa-design-for-barati-in-pagri-shop",
    type: "website",
  },
}
...
export default function SafaDesignForBaratiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Emergency last-minute service available in India", "Customized designs matching your wedding theme and outfit", "Expert safa specialists with 40+ years experience in India", "Authentic traditional tying techniques perfected over generations", "Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your India venue"],
