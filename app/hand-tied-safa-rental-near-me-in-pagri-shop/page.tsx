...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/hand-tied-safa-rental-near-me-in-pagri-shop",
    type: "website",
  },
}
...
export default function HandTiedSafaRentalNearMeInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert safa specialists with 40+ years experience in India", "Customized designs matching your wedding theme and outfit", "Perfect fit with maximum comfort guaranteed all day", "Complete barati packages with matching coordination", "Emergency last-minute service available in India", "Premium materials - silk, brocade, velvet, and designer fabrics"],
