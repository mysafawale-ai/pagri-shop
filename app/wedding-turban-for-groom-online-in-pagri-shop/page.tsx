...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/wedding-turban-for-groom-online-in-pagri-shop",
    type: "website",
  },
}
...
export default function WeddingTurbanForGroomOnlineInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Perfect fit with maximum comfort guaranteed all day", "Complete barati packages with matching coordination", "Free consultation and design preview via WhatsApp", "On-site professional service at your India venue", "Customized designs matching your wedding theme and outfit", "Premium materials - silk, brocade, velvet, and designer fabrics"],
