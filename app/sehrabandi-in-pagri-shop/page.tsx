...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/sehrabandi-in-pagri-shop",
    type: "website",
  },
}
...
export default function SehrabandiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert sehra specialists with 40+ years experience in India", "Free consultation and design preview via WhatsApp", "Competitive pricing for individual and bulk orders", "Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your India venue", "Premium materials - silk, brocade, velvet, and designer fabrics"],
