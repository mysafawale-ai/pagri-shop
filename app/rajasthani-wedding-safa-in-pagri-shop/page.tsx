...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/rajasthani-wedding-safa-in-pagri-shop",
    type: "website",
  },
}
...
export default function RajasthaniWeddingSafaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Authentic traditional tying techniques perfected over generations", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in India", "Expert safa specialists with 40+ years experience in India", "Complete barati packages with matching coordination"],
