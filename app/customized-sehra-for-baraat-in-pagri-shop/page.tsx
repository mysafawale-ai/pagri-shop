...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/customized-sehra-for-baraat-in-pagri-shop",
    type: "website",
  },
}
...
export default function CustomizedSehraForBaraatInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Complete barati packages with matching coordination", "Competitive pricing for individual and bulk orders", "Perfect fit with maximum comfort guaranteed all day", "Authentic traditional tying techniques perfected over generations", "On-site professional service at your India venue", "Customized designs matching your wedding theme and outfit"],
