...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/safa-tying-service-in-pagri-shop",
    type: "website",
  },
}
...
export default function SafaTyingServiceInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["On-site professional service at your India venue", "Perfect fit with maximum comfort guaranteed all day", "Premium materials - silk, brocade, velvet, and designer fabrics", "Complete barati packages with matching coordination", "Free consultation and design preview via WhatsApp", "Authentic traditional tying techniques perfected over generations"],
