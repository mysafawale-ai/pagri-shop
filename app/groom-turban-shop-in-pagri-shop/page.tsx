...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/groom-turban-shop-in-pagri-shop",
    type: "website",
  },
}
...
export default function GroomTurbanShopInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Authentic traditional tying techniques perfected over generations", "Premium materials - silk, brocade, velvet, and designer fabrics", "Expert turban specialists with 40+ years experience in India", "On-site professional service at your India venue", "Competitive pricing for individual and bulk orders", "Perfect fit with maximum comfort guaranteed all day"],
