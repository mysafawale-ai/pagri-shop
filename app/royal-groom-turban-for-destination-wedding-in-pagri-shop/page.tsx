...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/royal-groom-turban-for-destination-wedding-in-pagri-shop",
    type: "website",
  },
}
...
export default function RoyalGroomTurbanForDestinationWeddingInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Expert turban specialists with 40+ years experience in India", "Perfect fit with maximum comfort guaranteed all day", "Competitive pricing for individual and bulk orders", "On-site professional service at your India venue", "Emergency last-minute service available in India", "Premium materials - silk, brocade, velvet, and designer fabrics"],
