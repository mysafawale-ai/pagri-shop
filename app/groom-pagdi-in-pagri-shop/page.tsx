...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/groom-pagdi-in-pagri-shop",
    type: "website",
  },
}
...
export default function GroomPagdiInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Customized designs matching your wedding theme and outfit", "Expert pagdi specialists with 40+ years experience in India", "Perfect fit with maximum comfort guaranteed all day", "On-site professional service at your India venue", "Emergency last-minute service available in India"],
