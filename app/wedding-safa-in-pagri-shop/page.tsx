...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/wedding-safa-in-pagri-shop",
    type: "website",
  },
}
...
export default function WeddingSafaInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Premium materials - silk, brocade, velvet, and designer fabrics", "Customized designs matching your wedding theme and outfit", "Emergency last-minute service available in India", "Authentic traditional tying techniques perfected over generations", "Complete barati packages with matching coordination", "Competitive pricing for individual and bulk orders"],
