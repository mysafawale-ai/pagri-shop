...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: "https://pagri.shop/sehra-in-pagri-shop",
    type: "website",
  },
}
...
export default function SehraInIndiaPage() {
  const pageData = {
    ...
    areas: INDIA_AREAS,
    keyFeatures: ["Customized designs matching your wedding theme and outfit", "On-site professional service at your India venue", "Emergency last-minute service available in India", "Competitive pricing for individual and bulk orders", "Free consultation and design preview via WhatsApp", "Complete barati packages with matching coordination"],
